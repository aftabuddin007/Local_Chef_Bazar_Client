    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@localchefbazaar.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">MirPur1, Dhaka </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sunday - Friday: 7AM - 11PM</p>
                    <p className="text-gray-600">Saturday: 9AM - 11PM</p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 text-center border border-gray-200 hover:border-amber-300 transition-colors">
            <ChefHat className="h-10 w-10 text-amber-600 mx-auto mb-4" />
            <h3 className="font-semibold text-gray-900 mb-2">Become a Chef</h3>
