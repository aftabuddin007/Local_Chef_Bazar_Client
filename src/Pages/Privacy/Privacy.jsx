...
const PrivacyPolicyPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-base-50 to-base-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Introduction */}
        <div className="mb-10 p-6 bg-orange-600 rounded-xl shadow-sm border border-gray-200">
          <h2 className="text-2xl font-bold text-base-900 mb-4">Introduction</h2>
        ...
        <div className="mb-10">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-base-900">Information We Collect</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-base-100 p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 className="text-lg font-semibold text-base-900 mb-3">Personal Information</h3>
            ...
            <div className="bg-base-100 p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 className="text-lg font-semibold text-base-900 mb-3">Usage Information</h3>
              <ul className="space-y-2 text-base-700">
                <li className="flex items-start">
                  <span className="text-amber-600 mr-2">•</span>
        ...
        <div className="mb-10">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-base-900">How We Use Your Information</h2>
          </div>

          <div className="bg-base-100 p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-base-900 mb-3">For Customers</h3>
                <ul className="space-y-2 text-base-700">
                  <li className="flex items-start">
                    <span className="text-amber-600 mr-2">✓</span>
              ...
              <div>
                <h3 className="text-lg font-semibold text-base-900 mb-3">For Chefs</h3>
                <ul className="space-y-2 text-base-700">
                  <li className="flex items-start">
                    <span className="text-amber-600 mr-2">✓</span>
        ...
        <div className="mb-10">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-base-900">Data Sharing & Disclosure</h2>
          </div>
          ...
          <div className="bg-base-100 p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-base-900">With Chefs</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-base-900">Service Providers</h4>
                  <p className="text-base-700 text-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-base-900">Legal Requirements</h4>
                  <p className="text-base-700 text-sm">
        ...
        <div className="mb-10">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-base-900">Data Security</h2>
          </div>
        ...
        {/* Your Rights */}
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-base-900 mb-6">Your Privacy Rights</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Access & Correction</h3>
              <p className="text-base-700 text-sm">
            ...
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Data Deletion</h3>
              <p className="text-base-700 text-sm">
            ...
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Opt-Out</h3>
              <p className="text-base-700 text-sm">
            ...
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Cookies</h3>
              <p className="text-base-700 text-sm">
            ...
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Data Portability</h3>
              <p className="text-base-700 text-sm">
            ...
            <div className="bg-base-100 p-5 rounded-xl shadow-sm border border-gray-200">
              <h3 className="font-semibold text-base-900 mb-2">Complaints</h3>
              <p className="text-base-700 text-sm">
        ...
        {/* Children's Privacy */}
        <div className="mb-10 bg-base-50 border border-amber-200 rounded-xl p-6">
          <h2 className="text-xl font-bold text-base-900 mb-3">Children's Privacy</h2>
          <p className="text-base-700">
        ...
        {/* Changes to Policy */}
        <div className="mb-10 bg-base-50 border border-gray-200 rounded-xl p-6">
          <h2 className="text-xl font-bold text-base-900 mb-3">Changes to This Privacy Policy</h2>
        ...
        {/* Contact Information */}
        <div className="bg-base-100 rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-base-900 mb-4">Contact Us</h2>
          <p className="text-base-700 mb-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-base-700">privacy@localchefbazaar.com</span>
            </div>
        ...
        {/* Last Updated */}
        <div className="mt-8 text-center text-base-500 text-sm">
