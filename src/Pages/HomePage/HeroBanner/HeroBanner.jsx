...
const heroImage = [
  {
    ...
    "subtitle": "Discover authentic, homemade meals prepared with love by talented chefs in your neighborhood.",
  ...
  },
  {
    ...
    "subtitle": "From traditional family recipes to modern fusion, enjoy healthy food delivered straight to your door.",
    "image": "https://i.ibb.co.com/GvFS5RmV/pexels-ella-olsson-572949-1640772.jpg",
    "cta": "Find a Chef"
  },
  {
    "slogan": "Support local, eat better",
    "subtitle": "Join a community that celebrates local culinary talent and secure, real-time food tracking.",
            ...
            >
              <div className="bg-black/40 p-6 rounded-2xl text-center">
                ...
                <p className="text-lg md:text-2xl">{slide.subtitle}</p>
                              ...
                              <button className='btn btn-primary mt-15'>{slide.cta} <FaArrowRight />
</button>
